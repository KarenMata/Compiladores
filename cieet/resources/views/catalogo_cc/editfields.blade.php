                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::date('fecha_ini',null,['class'=>'form-control form-control-sm','required']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::select('estatus',['1'=>'Proceso','2'=>'Terminado','3'=>'Pausado'],null,['class'=>'form-control inputSlim','placeholder'=>'Selecciona el estatus del proyecto','required']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::date('fecha_fin',null,['class'=>'form-control']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                            ...
                            <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%" id='table_part'>
                                <tbody>  
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group" style="margin-bottom: 0px">
                                                {!! Form::select('participante[]',$usuarios,$participante->id_usuario,['class'=>'form-control form-control-sm','placeholder'=>'Seleccione participante...']) !!}<i class="form-group__bar"></i>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
