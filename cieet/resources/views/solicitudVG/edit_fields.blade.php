                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::date('fechaSol',null,['class'=>'form-control form-control-sm']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::date('fechaSal',null,['class'=>'form-control form-control-sm']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                        ...
                        <tr>
                            <td><div class="listview__attrs" style="margin: 0">
                                    <span style="margin: 0;padding-top: 5px;padding-bottom: 3px;">
                                        <label class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id='gasolina' name='gasolina' <?php if($solVG->gasolina == 1) echo "checked"; ?>>
                            ...
                            <td>
                                <div class="listview__attrs" style="margin: 0">
                                    <span style="margin: 0;padding-top: 5px;padding-bottom: 3px;">
                                        <label class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id='alimentos' name='alimentos' <?php if($solVG->alimentos == 1) echo "checked"; ?>>
                                            <span class="custom-control-indicator"></span>
                            ...
                            <td>
                                <div class="listview__attrs" style="margin: 0">
                                    <span style="margin: 0;padding-top: 5px;padding-bottom: 3px;">
                                        <label class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id='hospedaje' name='hospedaje' <?php if($solVG->hospedaje == 1) echo "checked"; ?>>
                                            <span class="custom-control-indicator"></span>
                            ...
                            <td>
                                <div class="listview__attrs" style="margin: 0">
                                    <span style="margin: 0;padding-top: 5px;padding-bottom: 3px;">
                                        <label class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id='otroSol' name='otroSol' <?php if($solVG->otroSol == 1) echo "checked"; ?>>
                                            <span class="custom-control-indicator"></span>
                        ...
                        <tr>
                            <td>
                                <div class="listview__attrs" style="margin: 0">
                                    <span style="margin: 0;padding-top: 5px;padding-bottom: 3px;">
                                        <label class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id='tarjEden' name='tarjEden' <?php if($solVG->tarjEden == 1) echo "checked"; ?>>
                                            <span class="custom-control-indicator"></span>
                            ...
                            <td>
                                <div class="listview__attrs" style="margin: 0">
                                    <span style="margin: 0;padding-top: 5px;padding-bottom: 3px;">
                                        <label class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id='tarjDeb' name='tarjDeb' <?php if($solVG->tarjDeb == 1) echo "checked"; ?>>
                                            <span class="custom-control-indicator"></span>
                            ...
                            <td>
                                <div class="listview__attrs" style="margin: 0">
                                    <span style="margin: 0;padding-top: 5px;padding-bottom: 3px;">
                                        <label class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id='efectivoER' name='efectivoER' <?php if($solVG->efectivoER == 1) echo "checked"; ?>>
                                            <span class="custom-control-indicator"></span>
                            ...
                            <td>
                                <div class="listview__attrs" style="margin: 0">
                                    <span style="margin: 0;padding-top: 5px;padding-bottom: 3px;">
                                        <label class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id='otroEnt' name='otroEnt' <?php if($solVG->otroEnt == 1) echo "checked"; ?>>
                                            <span class="custom-control-indicator"></span>
                                            <span class="custom-control-description">Otro</span>
                                        </label>
                                    </span>
                        ...
                        <tr>
                            <td>
                                <div class="listview__attrs" style="margin: 0">
                                    <span style="margin: 0;padding-top: 5px;padding-bottom: 3px;">
                                        <label class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id='recibe' name='recibe' <?php if($solVG->recibe == 1) echo "checked"; ?>>
                                            <span class="custom-control-indicator"></span>
                            ...
                            <td>
                                <div class="listview__attrs" style="margin: 0">
                                    <span style="margin: 0;padding-top: 5px;padding-bottom: 3px;">
                                        <label class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id='entrega' name='entrega' <?php if($solVG->entrega == 1) echo "checked"; ?>>
                                            <span class="custom-control-indicator"></span>
                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::time('hrApSal',null,['class'=>'form-control form-control-sm']) !!}<i class="form-group__bar"></i>
                                </div>
                            <td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::time('hrApLle',null,['class'=>'form-control form-control-sm']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::time('hrReSal',null,['class'=>'form-control form-control-sm']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::time('hrReLle',null,['class'=>'form-control form-control-sm']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::date('fechaLle',null,['class'=>'form-control form-control-sm']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
            ...
            <div class="col-lg-3 col-md-3 col-sm-12">
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%" id='table_nom'>
                    <tbody>
                        ...
                        @foreach($solCom as $solC)
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::text('nomb[]',$solC->nombre,['class'=>'form-control form-control-sm']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                        @endforeach
                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%" id='table_act'>
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::text('act[]',$solC->actividad,['class'=>'form-control form-control-sm']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                        @endforeach
                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%" id='table_asis'>
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::text('as_si[]',$solC->as_si,['class'=>'form-control form-control-sm']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::text('as_no[]',$solC->as_no,['class'=>'form-control form-control-sm']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                        @endforeach
                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%" id='table_obj'>
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::text('obj[]',$solC->objetivo,['class'=>'form-control form-control-sm']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                        @endforeach
                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%" id='table_obs'>
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::text('obs[]',$solC->observaciones,['class'=>'form-control form-control-sm']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                        @endforeach
                    ...
                    <div class="col-lg-4 col-md-4">
                        <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%" id='table_conc'>
                            <tbody>  
                                ...
                                @foreach($solRCE as $solR)
                                <tr>
                                    <td>
                                        <div class="form-group" style="margin-bottom: 0px">
                                            {!! Form::text('concepto[]',$solR->concepto,['class'=>'form-control form-control-sm']) !!}<i class="form-group__bar"></i>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
                        ...
                        <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%" id='table_mont'>
                            <tbody>  
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group" style="margin-bottom: 0px">
                                            {!! Form::text('monto[]',$solR->monto,['class'=>'form-control form-control-sm']) !!}<i class="form-group__bar"></i>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
                        ...
                        <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%" id='table_rfna'>
                            <tbody>  
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group" style="margin-bottom: 0px">
                                            {!! Form::text('rfna[]',$solR->rec_fac_na,['class'=>'form-control form-control-sm']) !!}<i class="form-group__bar"></i>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
