<div class="row justify-content-md-center" id="compras">
	<div class="col-md-12 col-sm-12 col-xs-12"><h2>NUEVO MOVIMIENTO EN BANCO BANORTE</h2></div>
	<div class="col-md-12 col-sm-12 col-xs-12" style="padding-bottom: 60px"><hr></div>
    <input type="hidden" name="banco" value="Banorte">
    <div class="col-md-3 col-sm-3 col-xs-12 col-md-offset-4 spadd_extremos" style="padding-bottom: 40px">
    ...
    <div class="col-md-3 col-sm-3 col-xs-12 col-md-offset-4 padd_extremos" style="padding-bottom: 40px">
