                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::select('factura',$facturas,null,['class'=>'form-control form-control-sm','required','placeholder'=>'Seleccione...','onchange'=>'buscaFactura()','id'=>'factura']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::text('ivaRet',null,['class'=>'form-control form-control-sm','disabled','id'=>'ivaRet']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::text('isrRet',null,['class'=>'form-control form-control-sm','disabled','id'=>'isrRet']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::text('otro',null,['class'=>'form-control form-control-sm','disabled','id'=>'otro']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
    ...
    <div class="card-body">
        <div class="row"> 
            <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                ...
                <a class="btn btn-danger" href="{{url('/catalogo_cc/detalle/'.$cc->id)}}"><i class="fa fa-times"></i> Cancelar</a>
            </div>
        </div>
    </div>
</div>