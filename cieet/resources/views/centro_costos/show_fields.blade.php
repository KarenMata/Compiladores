                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::text('partida',null,['class'=>'form-control form-control-sm','disabled']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::text('avance',null,['class'=>'form-control form-control-sm','disabled']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::text('ivaRet',null,['class'=>'form-control form-control-sm','disabled']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::text('isrRet',null,['class'=>'form-control form-control-sm','disabled']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::text('otro',null,['class'=>'form-control form-control-sm','disabled']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
