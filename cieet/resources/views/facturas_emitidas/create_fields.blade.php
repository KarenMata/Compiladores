                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::text('concepto',null,['class'=>'form-control form-control-sm','required','id'=>'concepto']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::text('subtotal',null,['class'=>'form-control form-control-sm','required','id'=>'subtotal']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::text('iva',null,['class'=>'form-control form-control-sm','required','id'=>'iva']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                ...
                <table class="dataTable table-borderless table-condensed table-hover" style="width: 100%">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" style="margin-bottom: 0px">
                                    {!! Form::text('total',null,['class'=>'form-control form-control-sm','required','id'=>'total']) !!}<i class="form-group__bar"></i>
                                </div>
                            </td>
                        </tr>
                    </tbody>
