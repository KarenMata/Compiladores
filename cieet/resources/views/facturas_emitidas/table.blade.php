                ...
                <td>
                    <div class="btn-group" role="group">
                        ...
                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 33px, 0px); top: 0px; left: 0px; will-change: transform; padding-top: 0px; padding-bottom: 0px">
                            <a href="{{url('/facturasEmitidas/edit/'.$fac->id)}}" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> Editar </a><br>
                            <a href="{{url('/facturasEmitidas/show/'.$fac->id)}}" class="btn btn-white btn-sm"><i class="fa fa-eye"></i> Ver </a><br>
                            <a onclick="borrarFE({{$fac->id}})" class="btn btn-white btn-sm"><i class="fa fa-trash-o"></i> Borrar </a>
                        </div>
                    </div>
                </td>
            </tr>
